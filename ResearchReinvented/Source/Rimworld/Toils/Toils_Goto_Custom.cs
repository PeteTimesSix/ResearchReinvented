...
namespace PeteTimesSix.ResearchReinvented.Rimworld.Toils
{
    ...
    {
		public static Toil GoAdjacentToThing(TargetIndex ind, bool cardinalOnly)
		{
			Toil toil = new Toil();
			toil.initAction = delegate ()
			{
				Pawn actor = toil.actor;
				var reachable = AdjacencyHelper.GenReachableAdjacentCells(actor.jobs.curJob.GetTarget(ind).Thing, actor, true);
